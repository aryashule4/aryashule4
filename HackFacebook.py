...
for xd in range(1000):
   ...
   oppo = ["CPH1869", "CPH1979"]
   redmi = ["2201116SI", "M2012K11C", "22021211RC"]
   realme =  ["RMX3516", "RMX2052", "RMX2176", "RMX2121", "RMX3115", "RMX1921"]
   infinix = ["X676B", "X6811"]
   samsung = ["E025F", "G3818", "G388F", "G389F", "G390F", "G398FN"]
   gt = ['GT-1015','GT-X890','GT-Y8750']  
