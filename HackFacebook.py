...
for xd in range(1000):
   ...
   strvrealme = f"Mozilla/5.0 Linux; Android {str(rr(6,13))}; SM-RMX1945 Build/MMB29K; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36 GSA/12.22.8.23.arm"
   ...
   uakulah = random.choice([strvrealme, strvredmi,strvoppo1, strvinfinix])
   ugen.append(uakulah)    
