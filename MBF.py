...
def install_browser():
	...
	br.addheaders = [('Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Mobile Safari/537.36')]
def bacaData():
...
def login():
	...
	buka('https://id-id.facebook.com/login.php/')
	br.select_form(nr=0)
	br.form['email']=us
	br.form['pass']=pa
	br.submit()
	...
	if 'save-device' in url or 'm_sess' in url:
		buka('https://m.facebook.com/bookmarks/')
...
def idteman():
	...
	buka('https://m.facebook.com/friends/?target_pivot_link=friends')
